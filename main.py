#этот код изначально был в ветке new1 файл main.py
import telebot
import datetime
import time
import threading
...
first_rem = ''  # инициализация переменных времени для напоминаний
second_rem = ''
end_rem = ''

bot = telebot.TeleBot('7522711422:AAFyZH8HkAgP0H4ayd-J-g2aWic-5RJzWWE')
...
def start_message(message):  # сейчас мы б. обрабат. команду /start
    ...
    # replay_to() - отвечает на сообщения польз-ля
